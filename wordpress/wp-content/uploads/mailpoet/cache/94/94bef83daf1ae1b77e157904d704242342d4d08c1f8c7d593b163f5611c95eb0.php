...
class __TwigTemplate_19ca028299ca1d795bc036078d9a99236a1b0428b1959484279d4a751967271f extends \MailPoetVendor\Twig\Template
{
  ...
  <textarea placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" disabled=\"disabled\" rows=\"{{#if params.lines}}{{ params.lines }}{{else}}1{{/if}}\">{{ params.text }}</textarea>
    ...
    {
        return new Source("", "form/templates/blocks/textarea.hbs", "/home/gen-004/Documents/TRAVAIL/DEV/wp_project/wordpress/wp-content/plugins/mailpoet/views/form/templates/blocks/textarea.hbs");
    }
}
